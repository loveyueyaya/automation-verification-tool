...
> **权威源声明（2026-09-19）**：本文件为技能侧速查参考；**环境权威数据以
> `F://自动化验证工具//10-env-baseline//env-baseline_v1.md` 及同目录 09-19 系列报告为准**（含 pip 快照、事故取证、损失评估、API 验证）。
> 两者数据冲突时以 `10-env-baseline` 为准，并回来修正本文件。
