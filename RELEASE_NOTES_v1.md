# P1 Release (ui-toolbox-P1-20260916+2026-09-16 22:54:04)

- 日期：2026-09-16
- 内容：contracts + env_adapter + tests + scripts（重建版）
- 测试：56/56 通过
- 已知偏差：见 MIGRATION.md 第 6.3 / 7.8 节
- pyc 备份：F:\自动化验证工具\P1_pyc缓存备份_20260916
